...
de.biancoroyal.modbus.core.server.internalDebug = de.biancoroyal.modbus.core.server.internalDebug || require('./modbus-logger').getDebugLogger('contribModbusServer:core:server') // eslint-disable-line no-use-before-define
